...
void inputMtrx(int32_t** matrix, size_t size_i, size_t size_j) {
	for (size_t i = 0; i < size_i; ++i) {
		for (size_t j = 0; j < size_j; ++j) {
			std::cin >> matrix[i][j];
		}
...
void input_selection(int32_t** matrix, size_t size_i, size_t size_j) {
	size_t op;
	...
	default:std::cout << "1 and 0";
		break;
	case 0:
		inputMtrx(matrix, size_i, size_j);
		break;
	case 1:
...
void outputMtrx
(int32_t** matrix, size_t size_i, size_t size_j) {
	for (size_t i = 0; i < size_i; ++i) {
		for (size_t j = 0; j < size_j; ++j) {
...
int main() {
	...
	input_selection(matrix, size_i, size_j);
	system("cls");
	outputMtrx
